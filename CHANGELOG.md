...
- `1.21.5(-10)`: Update compatibility recipes for [Nemo's Campfires](https://www.modrinth.com/mod/nemos-campfires) to match the new `2.x` version
    > **Note for** `1.21.5(6)`:  
    As [Nemo's Campfires](https://www.modrinth.com/mod/nemos-campfires) currently has no `2.x` version for `1.21.5(6)`, the compatibility recipes in `1.21.5(-10)` will no longer work in `1.21.5(6)` as long as no compatible `Nemo's Campfires 2.x` exists.